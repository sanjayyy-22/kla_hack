...
def solve_delivery_optimization(distance_matrix, capacity, neighborhoods):
    ...
    while unvisited:
        ...
        while current_capacity + neighborhoods[f'n{current}']['order_quantity'] <= capacity:
            print(neighborhoods[f'n{current}']['order_quantity'],current_capacity,capacity)
...
def main():
    ...
    input_json_file =  r"C:\21pw29\Student Handout\Input data\hackathon\level1a.json"
    ...
    output_json_file = "your_output1aa.json"  # Replace with your desired output file name
